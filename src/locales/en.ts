export default {
  ...
  // Info Strip
  infoStrip1: "Uniting autonomous supply chains with real-time Earth and cyber domain threat signals",
  infoStrip2: "Powering defense logistics through AI and persistent global threat sensing",
  infoStrip3: "Operationalizing AI logistics with real-time adversarial scanning and network intrusion intelligence",
  infoStrip4: "Leveraging predictive logistics coordination with persistent intelligence from global sensor-based threat tracking",
  // Mission Statement
  missionTitle: "Our Mission",
  missionText: "An integrated defense platform that combines AI-powered logistics orchestration with continuous cyber and Earth intelligence. Real-time threat data is gathered via a globally distributed sensor array, analyzed to identify adversarial behavior, and fused with geospatial awareness to support resilient, responsive, and secure mission planning.",
  // Core Capabilities
  coreCapabilitiesTitle: "Core capabilities",
  capability1Title: "AI-Powered Logistics",
  capability1Desc: "Predictive and autonomous supply chain routing with real-time risk adaptation.",
  capability2Title: "Cyber Threat Intelligence",
  capability2Desc: "Continuous detection of scanning, intrusions, and emerging campaigns using global sensors.",
  capability3Title: "Autonomous Cyber Deception",
  capability3Desc: "AI-driven deployment of deceptive assets to mislead, slow, and expose threat actors.",
  capability4Title: "APT Defense",
  capability4Desc: "Proactive profiling and disruption of sophisticated, state-sponsored or persistent adversaries.",
  capability5Title: "Insider Threat Detection",
  capability5Desc: "Behavioral analytics combined with deception to identify anomalous internal access.",
  capability6Title: "Ransomware Mitigation",
  capability6Desc: "Real-time risk assessment, segmentation, and decoy data assets to isolate and neutralize threats.",
  capability7Title: "Real-Time Earth Intelligence",
  capability7Desc: "Environmental and spatial data integration for logistics routing, physical threat avoidance, and operational situational awareness.",
  // Problem
