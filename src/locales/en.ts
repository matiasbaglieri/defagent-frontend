export default {
  ...
  blogPost3Summary: "A deep dive into CiberG integration and how automated CVE ingestion transforms threat signals into actionable defense mechanisms.",
  blogPost3Link: "https://defagent.ai/blog/cve-to-countermeasure",
  blogPost4Title: "Inside Our Field Kits: What Makes a GoTAK Deployment So Effective",
  blogPost4Date: "April 24, 2025",
  blogPost4Summary: "An inside look at how ruggedized EUDs, mesh radios, and DefAgent create a rapid-deploy TAK ecosystem for real-world operations.",
  ...
  post2_p6: "Want to see TAK + AI in action?",
  post2_cta: "Schedule a Demo",
}; 